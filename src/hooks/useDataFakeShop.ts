...
const useDataFakeShop = () => {
    ...
    function getCategoriesFakeShop() {
        fetchData<FakeCategory>('https://api.escuelajs.co/api/v1/categories').then(data => {
    ...
    function getProductsFakeShop() {
        fetchData<FakeProduct>('https://api.escuelajs.co/api/v1/products').then(data => {
    ...
    function getUserFakeShop() {
        fetchData<FakeUser>('https://api.escuelajs.co/api/v1/users').then(data => {
