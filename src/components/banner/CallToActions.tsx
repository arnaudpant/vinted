export const CallToAction = () => {
  return (
    <div className="flex flex-col w-11/12  bg-white items-center justify-evenly my-2 mx-2 h-32  sm:bg-white  sm:items-start sm:h-64 sm:w-80 sm:absolute sm:inset-0 sm:ml-24 sm:mt-16">
      ...
      <button className="bg-vintedGreen py-2 text-white rounded-sm text-center w-full sm:w-11/12 self-center cursor-pointer ">
        Vends maintenant
      </button>

      <a
        href=""
        className=" text-vintedGreen sm:underline text-base  sm:text-sm sm:ml-4 sm:relative top-[-12px]"
      >
